	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			<section id="content">
				...
				<!-- ************ - BEGIN Breadcrumbs - ************** -->
				<div id="breadcrumbs">
					<a title="Home" href="#">Home »</a>  Portfolio 1 Column
				</div><!--/ breadcrumbs-->	
				<!-- ************ - END Breadcrumbs - ************** -->
				...
				<section class="gallery-list gl_col_1">	
					...
					<article class="gallery-item">
						<div class="entry clearfix">
							<div class="gallery-image plus-icon">
								<a href="images/gallery/fullscreen/2.jpg" class="zoomer" rel="group">
									<img src="images/gallery/thumbs/portfolio_1_1.jpg" alt=""/>
								</a>
							</div><!--/ gallery-image-->
							<div class="gallery-text">
								<h4><a href="portfolio-single.html">Excepteur sint occaecat</a></h4>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut 
									labore et dolore magna aliqua. 
								</p>
								<p><a href="portfolio-single.html" class="button gray small">Read more</a></p>
								<p><a class="other-link" href="http://www.themeforest.net" target="_blank">Lorem ipsum dolor sit amet</a></p>
							</div><!--/ gallery-text--> 			
						</div><!--/ .entry-->
						<div class="clear"></div>
					...
					<article class="gallery-item">
						<div class="entry clearfix">
							<div class="gallery-image plus-icon">
								<a href="images/gallery/fullscreen/1.jpg" class="zoomer" rel="group">
									<img src="images/gallery/thumbs/portfolio_1_2.jpg" alt=""/>
								</a>
							</div><!--/ gallery-image-->
							<div class="gallery-text">
								<h4><a href="portfolio-single.html">Usmod tempor incididunt ut</a></h4>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut 
									labore et dolore magna aliqua. 
								</p>
					...
					<article class="gallery-item">
						<div class="entry clearfix">
							<div class="gallery-image plus-icon">
								<a href="images/gallery/fullscreen/4.jpg" class="zoomer" rel="group">
									<img src="images/gallery/thumbs/portfolio_1_3.jpg" alt=""/>
								</a>
							</div><!--/ gallery-image-->
							<div class="gallery-text">
								<h4><a href="portfolio-single.html">Ad minim veniam quis nos</a></h4>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut 
									labore et dolore magna aliqua. 
								</p>
				...
				<div class="pagenavi">
					...
					<a href="#" title="2" class="page">2</a>
					<a href="#" title="3" class="page">3</a>
					<a href="#" title="4" class="page">4</a>
					<a href="#" title="5" class="page">5</a>
				</div><!--/ pagenavi -->
				<!-- ************ - END Page navigation - ************** -->	
