	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			<section id="content">
				...
				<!-- ************ - BEGIN Breadcrumbs - ************** -->
				<div id="breadcrumbs">
					<a title="Home" href="#">Home »</a>  Headings
				</div><!--/ breadcrumbs-->	
				<!-- ************ - END Breadcrumbs - ************** -->
				...
				<div class="content-wrapper">
						...
						$result = mysql_query("select * from fproduct ") or die("error in query");
						...
						<p>
							...
							<img src="images/featureproduct/<?php echo $row['imgurl'];?>" height="80px;" width="100px;" alt="" />
							<?php } ?>
